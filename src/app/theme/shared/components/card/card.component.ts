...
export class CardComponent implements OnInit {
  ...
  constructor(private router: Router,animationService: AnimationService, config: NgbDropdownConfig) {
  ...
  nuevo(){
    if (this.cardTitle=="Lista de usuarios") {
      this.router.navigate(['usuarios/nuevo']);
    }else if (this.cardTitle=="Lista de Choferes") {
      this.router.navigate(['chofer/nuevo']);
    }else if (this.cardTitle=="Lista de Camiones") {
      this.router.navigate(['camion/nuevo']);
    }else if (this.cardTitle=="Lista de Clientes") {
      this.router.navigate(['cliente/nuevo']);
    }else if (this.cardTitle=="Lista de Agencias") {
      this.router.navigate(['agencia/nuevo']);
    }
  }
