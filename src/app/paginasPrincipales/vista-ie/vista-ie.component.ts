...
@Component({
  selector: 'app-vista-ie',
  templateUrl: './vista-ie.component.html',
  styleUrls: ['./vista-ie.component.scss'],
  providers: [Literal]
})
export class VistaIEComponent implements OnInit {
  agencias: any[];
  id1:any;
  id:any;
  origen:any;
  ...
  volver(){
    ...
    this.router.navigate([`ingreso-dinero`]);
  }
  ver(){
