...
@Component({
  selector: 'app-imprecion-desembarco',
  templateUrl: './imprecion-desembarco.component.html',
  styleUrls: ['./imprecion-desembarco.component.scss'],
  providers: [DecimalPipe]
})
export class ImprecionDesembarcoComponent implements  AfterViewInit,OnInit {
  ...
  reporteRecepcion(){
    ...
    this.reporte.tipo_transaccion="DESEMBARCO";
    this.reporte.tipo="";
  ...
  imprimir(item){
    this.reimprimir1.id_desembarco=item.id;
  ...
  this.excelService.exportAsExcelFile(this.expor, 'IMPRECION DESEMBARQUE');
}
}
